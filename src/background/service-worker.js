...
// v0.51.4 - Auto-embed integrity hash for Premium, subscription auto-renewal/cancellation notice
...
function generateContinuationHandoff(data, platform, mode) {
  ...
  return '# LISA SESSION REBIRTH — CONTINUATION DIRECTIVE\n\n'
    ...
    + '4. Your first reply: confirm in \u22645 lines (a) the task you are resuming,\n'
    + '   (b) current state, (c) the next open thread you will address. Then stop\n'
    + '   and await the user. Do not begin unsolicited work.\n'
    ...
    + '> LISA Core v0.51.4 | Phoenix Generation: ' + (data.phoenix ? data.phoenix.generation : 1) + '\n'
    ...
    + '### Reading Protocol\n'
    + 'This handoff must be processed in its entirety before any response is generated. '
    + 'Do not skim, selectively parse, or infer context from partial content. '
    + 'Every block above is source of truth.\n\n'
    + '### Enforcement Directives\n'
    + '1. **READ COMPLETE**: Process all conversation blocks sequentially before forming any response.\n'
    + '2. **SOURCE FIDELITY**: All claims, decisions, and context in this handoff are verified. '
    + 'Do not contradict, re-derive, or silently override them.\n'
    + '3. **NO HALLUCINATION**: Do not introduce entities, decisions, or conclusions not present in this handoff.\n'
    + '4. **CONFLICT PROTOCOL**: If the user’s new request conflicts with handoff context, '
    + 'flag the conflict explicitly — do not assume precedence.\n'
    + '5. **ACKNOWLEDGE**: Confirm receipt of this handoff context when beginning your response.\n'
    + '6. **CONTINUATION**: This is a reborn session (Generation ' + (data.phoenix ? data.phoenix.generation : 1) + '). '
    + 'Resume work, do not restart.\n\n'
    + '---\n'
    + '*LISA Core v0.51.4 • SAT-CHAIN LLC • Phoenix Session Rebirth*\n';
}
...
console.debug('[LISA] Core compression engine initialized v0.51.4');